...
/// </summary>
public sealed class CarbideModel
{
    ...
    public double KPD_min  { get; set; } = 0.76;
    public double KPD_max  { get; set; } = 0.89;
    ...
    public CarbideModel(ModelParameters p)
    {
    ...
    {
        double sumG  = controls.G_izvest + controls.G_coks;
    ...
    public SimulationStep Advance(SimulationStep s, ControlInputs controls)
    {
        ...
        double newMraspl = s.Mraspl      + DtStep * CalcGprod(t);
